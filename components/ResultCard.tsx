...
export default function ResultCard({ result, agency, action, isMock }: ResultCardProps) {
  ...
  const downloadPdf = () => {
    ...
    doc.text("JuanGuide Reference", 20, 20);
    ...
    doc.text("Generated by JuanGuide AI - Verify with official sources.", 20, pageHeight - 10);
    
    doc.save(`JuanGuide-${agency.replace(/\s+/g, '-')}.pdf`);
  };
