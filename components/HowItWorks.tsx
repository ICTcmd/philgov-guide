    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="py-12 px-6 mx-auto max-w-screen-xl lg:py-18 lg:px-8">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold font-display text-brand-secondary dark:text-white">How It Works</h2>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {steps.map((item, index) => (
            <div key={index} className="p-6 bg-white rounded-lg border border-blue-100 shadow-sm dark:bg-gray-800 dark:border-gray-700">
              <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-brand-accent dark:bg-blue-900 text-brand-primary dark:text-blue-300 font-bold text-xl">
                {item.step}
              </div>
